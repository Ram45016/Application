        ...
        <div className="form-box signup">
          ...
          <form onSubmit={submitSignUpForm} className="signUpForm">
            ...
            <div className="newUsername">
              <input type="text" name="newUsername" id="name" placeholder="Username" autoComplete="current-username" onChange={handleSignUpFormChange} />
            </div>
            <div className="newPassword">
              <input type="password" name="newPassword"  id="Pwd"  placeholder="Password" autoComplete="current-password" onChange={handleSignUpFormChange}/>
            </div>
