...
import { addProject, clearProjects } from '../components/Redux/ProjectSlice'; // Adjust the path based on your directory structure
    ...
    return (
        <div className='project-comp'>
            ...
            {projectsFromRedux.length > 0 ? (
                <ProjectView project={projectsFromRedux[0]} />
            ) : (
