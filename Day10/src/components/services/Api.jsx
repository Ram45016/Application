...
export const DelteProject=(id)=>axios.delete(`${url}/api/v1/auth/project/delete/${id}`,headers);
export const DeleteAllProject=()=>axios.delete(`${url}/api/v1/auth/project/deleteAll`,headers);
